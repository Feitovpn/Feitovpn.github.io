...
var notices = [
	...
	'* 大陆地区用户我们强烈建议您收藏当前页面(feitovpn.github.io)。'
];
...
window.onload = function () {
    ...
    logoElem.innerHTML = '<h1 class="flag">Feito 飞兔加速器</h1>'
    mainElem.appendChild(logoElem);

    // newest urls
    var newestFieldElem = createFieldElem({title: 'Feito 飞兔加速器最新地址', items: newestUrls, text: '请使用https://协议访问Feito 飞兔加速器'});
    ...
    // forever urls
    var foreverFieldElem = createFieldElem({title: 'Feito 飞兔加速器永久地址', items: foreverUrls});
